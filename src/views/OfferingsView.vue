...
const tabs: { name: () => string; key: OfferingKey; component: unknown }[] = [
  { name: () => i18n.global.t('offerings.streetFoodCorner.info.title'), key: 'street-food', component: StreetFoodCorner },
  { name: () => i18n.global.t('offerings.minimarket.info.title'), key: 'mini-market', component: Minimarket },
  { name: () => i18n.global.t('offerings.mealKit.info.title'), key: 'meal-kits', component: MealKit },
];
...
<template>
  <section class="pt-4 lg:pt-6 mb-16">
    <div class="container">
      <div class="flex flex-col items-start gap-8 lg:gap-10">
